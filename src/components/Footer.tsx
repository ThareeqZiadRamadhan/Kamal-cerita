        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-white/80 hover:text-[#CDDC39] transition-colors" style={{ fontSize: '14px' }}>
                  Home
                </a>
              </li>
              <li>
                <a href="#about" className="text-white/80 hover:text-[#CDDC39] transition-colors" style={{ fontSize: '14px' }}>
                  About Us
                </a>
              </li>
              <li>
                <a href="#potential" className="text-white/80 hover:text-[#CDDC39] transition-colors" style={{ fontSize: '14px' }}>
                  Village Potential
                </a>
              </li>
              <li>
                <a href="#news" className="text-white/80 hover:text-[#CDDC39] transition-colors" style={{ fontSize: '14px' }}>
                  Latest News
                </a>
              </li>
            </ul>
